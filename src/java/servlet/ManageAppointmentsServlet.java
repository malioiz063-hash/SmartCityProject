    ...
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            PreparedStatement ps =
                    ...
                    "SELECT * FROM appointments WHERE department=? ORDER BY id DESC");
            ...
            out.println("<html><head><title>Manage Appointments</title>");
            ...
            out.println("<h2>Manage Appointments</h2>");
            ...
            while(rs.next()){
                ...
                out.println("<form action='UpdateAppointmentStatusServlet' method='post'>");
                ...
                out.println("<option "
                        +(currentStatus.equals("Approved")?"selected":"")
                        +">Approved</option>");

                out.println("<option "
                        +(currentStatus.equals("Rejected")?"selected":"")
                        +">Rejected</option>");
